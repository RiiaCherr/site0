<?php
    class Person{
        ...
        public function getInfo(){
            ...
            if($this->father != null){
                $result .= "<br>Имя папы: ".$this->getFather()->name;
                if($this->father->mother != null){
                    $result .= "<br>Имя бабушки по папиной линии: ".$this->mother->mother->name;
                }
                if($this->father->father != null){
                    $result .= "<br>Имя дедушки по папиной линии: ".$this->mother->father->name;
                }
            }
        }
    }
    $person7 = new Person("Viktor", "Ivanov", 77, null, null);
    $person6 = new Person("Anna", "Ivanova", 74, null, null);
    $person5 = new Person("Boris", "Petrov", 73, null, null);
